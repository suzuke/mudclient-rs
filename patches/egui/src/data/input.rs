...
pub enum Event {
    ...
    Key {
        ...
        /// Whether this key event originated from the numpad (numeric keypad).
        ///
        /// This allows applications to distinguish between numpad digit keys
        /// and main keyboard digit keys, which is useful for e.g. MUD clients
        /// that use numpad for directional movement.
